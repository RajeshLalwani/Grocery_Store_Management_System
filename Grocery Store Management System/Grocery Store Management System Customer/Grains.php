...
<body>
    ...
    <div class="product-list">
        ...
        // Fetch products
        $sql = "SELECT * FROM `product` WHERE p_category='grains products'";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="feature1">
                    ...
                    <a href="buy.php?id=' . $id . '">Buy Now</a>
                    <a href="cart.php?id=' . $id . '" class="add-to-cart">Add to Cart</a>
                </div>';
            }
        } else {
            echo '<p>No products found in the "Grains" category.</p>';
        }
